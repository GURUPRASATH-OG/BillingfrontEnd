    ...
    return (
        <div className="receipt-popup-overlay text-dark">
            <div className="receipt-popup">
                ...
                <p>
                    <strong>Order ID🎟️:</strong> {orderDetails.orderId}
                </p>
                <p>
                ...
                <p>
                    <strong>Payment Method:</strong>{orderDetails.paymentMethod==="CASH"? "CASH💸":"UPI💳"}
                </p>
                {
                    orderDetails.paymentMethod === "UPI" && (
                        <>
                        <p>
                            <strong>Razorpay OrderId</strong> {orderDetails.razorpayOrderId}
                        </p>
                    
                         <p>
                             <strong>Razorpay PaymentId</strong> {orderDetails.razorpayPaymentId}
                         </p>
                         </>
                    )
                }
